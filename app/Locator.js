...
//  style={this.props.size}style={this.props.color}
const canvas_style_init = {
    width: 800,
    height: 800,
}
export default class Locator extends React.Component {
    ...
    render() {
        ...
        const div_background_style = {
            width: canvas_style_init.width,
            height: canvas_style_init.height}
        ...
        return (
            ...
            <Grid.Column width={10} style={test}>
                ...
                <div style={div_style}>
                    <canvas ref="canvas" width={canvas_style_init.width} height={canvas_style_init.height} style={canvas_style}></canvas>
                </div>
                {/*<Ble_Device pos={pos}/>*/}
